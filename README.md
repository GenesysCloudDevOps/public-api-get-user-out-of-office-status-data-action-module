A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get User Out Of Office Status
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-user-out-of-office-status-data-action-module.git?ref=v1.0.0"
    action_name        = "Get User Out Of Office Status"
